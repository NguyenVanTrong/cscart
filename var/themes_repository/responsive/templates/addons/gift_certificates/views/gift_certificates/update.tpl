...
<div class="ty-control-group ty-gift-certificate__amount">
    ...
    <input type="text" id="gift_cert_amount" name="gift_cert_data[amount]" class="ty-gift-certificate__amount-input cm-numeric" data-p-sign="s" data-a-sep="" {if $base_currency.decimals_separator} data-a-dec="{$base_currency.decimals_separator}"{/if} size="5" value="{if $gift_cert_data}{$gift_cert_data.amount}{else}{$addons.gift_certificates.min_amount}{/if}" />
