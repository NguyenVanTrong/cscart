...
// remove XML entities from the request body
foreach(array('order-calculations-request', 'NotificationData', 'order-calculations-error') as $field) {
    if (!empty($_POST[$field])) {
        $_POST[$field] = SecurityHelper::removeXmlEntities($_POST[$field]);
    }
}
