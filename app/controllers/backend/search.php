...
if ($mode == 'results') {
    ...
    if (!empty($params['compact']) && $params['compact'] = 'Y') {
        list($objects, $search) = fn_search($params, Registry::get('settings.Appearance.admin_elements_per_page'));
        ...
        list($data, $search) = fn_search($params, Registry::get('settings.Appearance.admin_elements_per_page'));
