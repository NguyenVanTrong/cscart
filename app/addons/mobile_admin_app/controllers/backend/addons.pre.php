...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if ($mode == 'tw_connect') {
        ...
        return array(CONTROLLER_STATUS_REDIRECT, 'addons.update?addon=mobile_admin_app');
    }
    ...
    if ($mode == 'tw_disconnect') {
        ...
        return array(CONTROLLER_STATUS_REDIRECT, 'addons.update?addon=mobile_admin_app&disconnect=Y');
    }
    ...
    if ($mode == 'update' && $_REQUEST['addon'] == 'mobile_admin_app') {
    ...
    if ($_REQUEST['addon'] == 'mobile_admin_app') {
        ...
        $platinum_stores = fn_ex_twg_init_push_comment(fn_ex_twg_filter_connected_platinum_stores($stores));
        ...
        $view->assign('is_on_saas', fn_ex_twg_is_on_saas());
        $view->assign('connected_access_id', fn_ex_twg_get_connected_access_id());
    }
}
