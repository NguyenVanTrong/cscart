...
require_once(Registry::get('config.dir.addons') . 'mobile_admin_app/ExTwigmo/Core/Functions/fn.uc_functions.php');

if ($_SERVER['REQUEST_METHOD'] == 'POST') {

    if ($mode == 'upgrade_twigmo' && !fn_ex_twg_is_on_saas()) {
        ...
        fn_uninstall_addon('mobile_admin_app', false);
        ...
        fn_install_addon('mobile_admin_app', false);
...
if ($mode == 'upgrade_twigmo' and $action == 'step2' and isset($_SESSION['twigmo_upgrade'])  && !fn_ex_twg_is_on_saas()) {
    fn_start_scroller();
