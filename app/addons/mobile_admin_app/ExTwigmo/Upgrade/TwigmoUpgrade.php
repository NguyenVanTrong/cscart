...
use ExTwigmo\Core\Functions\UserAgent;
...
class TwigmoUpgrade
{
    ...
    private static $addon_path = 'mobile_admin_app/';
    private static $full_addon_path = 'addons/mobile_admin_app/';
    ...
    public static function downloadDistr()
    {
        ...
        $download_file_path = $download_file_dir . 'mobile_admin_app.tgz';
    ...
    {
        $file = $install_src_dir . '/addons/mobile_admin_app/' . $file_name . '.php';
        if (file_exists($file)) {
            require_once($file);
        }
    ...
    public static function backupSettings($upgrade_dirs)
    {
        ...
        foreach ($upgrade_dirs['backup_company_settings'] as $company_id => $dir) {
            ...
            $default_layout_id = fn_ex_twg_get_default_layout_id();
            ...
            if ($location) {
                ...
                if ($content) {
                    fn_ex_twg_write_to_file($dir . '/blocks.xml', $content, false);
    ...
    public static function restoreSettingsAndCSS($upgrade_dirs)
    {
        ...
        foreach ($upgrade_dirs['backup_company_settings'] as $company_id => $dir) {
            ...
            if (file_exists($backup_file)) {
                ...
                Exim::instance($company_id, fn_ex_twg_get_default_layout_id())->importFromFile($backup_file);
            }
        }
        Registry::set('runtime.company_id', $old_company_id);
