...
namespace ExTwigmo\Core\Functions\Image;
...
class TwigmoImage
{
    ...
    final public static function updateImagesByApiData(
        ...
        foreach ($images as $image) {
            ...
            $detailed_image = self::fn_ex_twg_get_image_by_api_data($image);
    ...
    final public static function updateIconsByApiData(
        ...
        if ($icon = self::fn_ex_twg_get_image_by_api_data($image)) {
            $icon_list[] = $icon;
        }
    ...
    final public static function getImagesPath()
    {
        $theme_path = fn_get_theme_path(
                '[relative]/[theme]',
                'C',
                fn_ex_twg_get_current_company_id()
        );

        $path =
            $theme_path
            . '/media/images/addons/mobile_admin_app/images/';
    ...
    {
        $company_id = !empty($company_id) ? $company_id : fn_ex_twg_get_current_company_id();
        $logos = fn_get_logos($company_id, fn_ex_twg_get_default_layout_id());
    ...
    */
    private static function fn_ex_twg_get_image_by_api_data($api_image)
    {
