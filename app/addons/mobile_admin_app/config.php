...
// addon version
fn_define('TWIGMO_VERSION', '3.10');

fn_define('TWIGMO_UPGRADE_DIR', Registry::get('config.dir.var') . 'mobile_admin_app/');
...
if (Registry::get('addons.mobile_admin_app.status') == 'A') {
    $settings = array();
...
if (file_exists(Registry::get('config.dir.addons') .'mobile_admin_app/local_conf.php')) {
    include(Registry::get('config.dir.addons') . 'mobile_admin_app/local_conf.php');
}
