...
class CompanySingleton
{
     ...
     * @param bool      $add_and    Whether to use "AND" before condition
     *
     * @return string part of SQL query
     */
    public function getCompanyCondition($db_field, $add_and = true)
    {
        ...
        return fn_get_company_condition($db_field, $add_and, $company_id);
    }
