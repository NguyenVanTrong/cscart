...
<div id="connect_settings">
    ...
    {if !$admin_access_id}
        {include file="addons/mobile_admin_app/settings/components/connect/license.tpl"}
    {/if}
    ...
    {literal}
        $(document).ready(function () {
            $('#mobile_admin_app_storefront,#mobile_admin_app_admin_app').toggle(twg_is_connected);
            $('#mobile_admin_app_twg_push').toggle(twg_is_connected && has_platinum_stores);
