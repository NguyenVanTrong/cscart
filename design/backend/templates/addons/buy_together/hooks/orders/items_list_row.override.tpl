{if $oi.extra.buy_together}
    ...
    <tr valign="top">
        <td>
            <div class="pull-left">
                <i id="on_{$product_key}" class="hand cm-combination icon-caret-right"></i>
                <i title="{__("collapse_sublist_of_items")}" id="off_{$product_key}" class="hand cm-combination hidden icon-caret-down"></i>
            </div>
