...
<tr>
    ...
    <td><input type="hidden" name="subscribers[{$s.subscriber_id}][email]" value="{$s.email}" />
        <span name="plus_minus" id="on_subscribers_{$s.subscriber_id}" alt="{__("expand_collapse_list")}" title="{__("expand_collapse_list")}" class="hand cm-combination-subscribers"><span class="icon-caret-right"> </span></span><span name="minus_plus" id="off_subscribers_{$s.subscriber_id}" alt="{__("expand_collapse_list")}" title="{__("expand_collapse_list")}" class="hand hidden cm-combination-subscribers"><span class="icon-caret-down"> </span></span><a href="mailto:{$s.email|escape:url}">{$s.email}</a>
    </td>
    <td>
