...
<tr {$_class}>
    <td>
        <div class="pull-left">
        <i id="on_gc_{$gift_key}" class="hand cm-combination icon-caret-right"></i><i title="{__("collapse_sublist_of_items")}" id="off_gc_{$gift_key}" class="hand cm-combination hidden icon-caret-down"></i>
        </div>
        <div class="pull-left">
            {__("gift_certificate")}&nbsp;
