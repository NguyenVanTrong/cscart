...
<script src="http://maps.googleapis.com/maps/api/js?v=3&amp;language={$smarty.const.CART_LANGUAGE|fn_store_locator_google_langs}&amp;{if $sl_settings.google_key}key={$sl_settings.google_key}{/if}" type="text/javascript"></script>
