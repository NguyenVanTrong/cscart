...
<div class="cm-tabs-content">
    <div id="content_tab_new_profile{$id}">
        ...
        {if !$field_name}
            <div class="control-group">
                <label for="elm_field_name" class="control-label cm-required">{__("profile_field_name")}{include file="common/tooltip.tpl" tooltip=__("text_character_identifier_tooltip")}:</label>
                <div class="controls">
