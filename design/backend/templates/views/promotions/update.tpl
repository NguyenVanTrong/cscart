...
<form action="{""|fn_url}" enctype="multipart/form-data" method="post" name="promotion_form" class="promotion form-horizontal form-edit  {if !$allow_save}cm-hide-inputs{/if}" >
