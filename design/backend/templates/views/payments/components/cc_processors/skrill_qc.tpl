...
<div class="control-group">
    ...
    <div class="controls">
        <input type="text" name="payment_data[processor_params][pay_to_email]" id="pay_to_email_{$payment_id}" value="{$processor_params.pay_to_email}"  size="60" onchange="Tygh.$('#validate_email_{$payment_id}').prop('href', '{"payment_notification.validate_email?payment=skrill_qc&payment_id=`$payment_id`&email="|fn_url nofilter}' +  Tygh.$(this).val()); Tygh.$('#validate_secret_word_{$payment_id}').prop('href', '{"payment_notification.validate_secret_word?payment=skrill_qc&payment_id=`$payment_id`&email="|fn_url nofilter}' +  Tygh.$(this).val() + '&cust_id=' + Tygh.$('#customer_id_{$payment_id}').val() + '&secret=' + Tygh.$('#secret_word_{$payment_id}').val()); return false;">&nbsp;<a href="{"payment_notification.validate_email?payment=skrill_qc&payment_id=`$payment_id`&email=`$processor_params.pay_to_email`"|fn_url}" onclick="Tygh.$.ceAjax('request', Tygh.$(this).prop('href'), {ldelim}method: 'GET', callback: fn_get_validate_email_{$payment_id}{rdelim}); return false;" id="validate_email_{$payment_id}">{__("validate_email")}</a>
    </div>
</div>
...
<div class="control-group">
    ...
    <div class="controls">
        <input type="text" name="payment_data[processor_params][secret_word]" id="secret_word_{$payment_id}" value="{$processor_params.secret_word}"  size="60" onchange="Tygh.$('#validate_secret_word_{$payment_id}').prop( 'href', '{"payment_notification.validate_secret_word?payment=skrill_qc&payment_id=`$payment_id`&email="|fn_url nofilter}' + Tygh.$('#pay_to_email_{$payment_id}').val() + '&cust_id=' + Tygh.$('#customer_id_{$payment_id}').val() + '&secret=' + Tygh.$(this).val()); return false;">&nbsp;<a href="{"payment_notification.validate_secret_word?payment=skrill_qc&payment_id=`$payment_id`&email=`$pay_to_email`&cust_id=`$processor_params.customer_id`&secret=`$processor_params.secret_word`"|fn_url}" onclick="Tygh.$.ceAjax('request', Tygh.$(this).prop('href'), {ldelim}method: 'GET', callback: fn_get_validate_secret_word_{$payment_id}{rdelim}); return false;" id="validate_secret_word_{$payment_id}">{__("validate_secret_word")}</a>
